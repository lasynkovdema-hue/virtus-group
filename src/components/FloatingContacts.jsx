...
export default function FloatingContacts() {
  return (
    <div className="fixed bottom-6 right-4 sm:right-6 z-50 flex flex-col gap-3">
      {messengers.map(({ name, href, color, shadow, icon }) => (
        <a
          key={name}
          href={href}
          target="_blank"
          ...
          className="w-12 h-12 rounded-full flex items-center justify-center text-white/70
            bg-stone/80 backdrop-blur-sm border border-white/10
            transition-all duration-200 hover:scale-110 hover:text-white hover:bg-stone active:scale-95"
        >
          {icon}
        </a>
      ))}
